...
class DBConnect:
    ...
    def update_device(self, database, table, data):
        ...
        self.temp_update_data(data=device)
        ...
        VALID_START_DATE, VALID_END_DATE, INVALID_REASON, ANCESTOR_CONCEPT_CODE, PREVIOUS_CONCEPT_CODE, MATERIAL, SANJUNG_NAME
    ...
    def update_data(self, database, table, domain, data, date):
        ...
        SELECT CONCEPT_CODE, CONCEPT_NAME, CONCEPT_SYNONYM, DOMAIN_ID, VOCABULARY_ID, CONCEPT_CLASS_ID,
        VALID_START_DATE,
        VALID_END_DATE, INVALID_REASON, ANCESTOR_CONCEPT_CODE, PREVIOUS_CONCEPT_CODE, MATERIAL, SANJUNG_NAME
